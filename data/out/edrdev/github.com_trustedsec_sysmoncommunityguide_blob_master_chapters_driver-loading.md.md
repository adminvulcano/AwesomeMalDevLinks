...
[Skip to content](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md) to refresh your session.Dismiss alert
...
[History](https://github.com/trustedsec/SysmonCommunityGuide/commits/master/chapters/driver-loading.md)

Open commit details

[View commit history for this file.](https://github.com/trustedsec/SysmonCommunityGuide/commits/master/chapters/driver-loading.md) History

200 lines (151 loc) · 9.1 KB
...
[Raw](https://github.com/trustedsec/SysmonCommunityGuide/raw/refs/heads/master/chapters/driver-loading.md)
...
[Permalink: Driver Loading](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#driver-loading)
...
[Permalink: Detection Value and Why It Matters](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#detection-value-and-why-it-matters)
...
[Permalink: Why Driver Loading is Low-Volume](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#why-driver-loading-is-low-volume)
...
[Permalink: Configuration Strategy: Log All, Exclude Known-Good](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#configuration-strategy-log-all-exclude-known-good)
...
[Permalink: Certificate Revocation Checking](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#certificate-revocation-checking)
...
[Permalink: Leveraging LOLDrivers Project](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#leveraging-loldrivers-project)

The LOLDrivers project ( [https://www.loldrivers.io/](https://www.loldrivers.io/)) is an invaluable resource for detecting BYOVD attacks. The project maintains:
...
1. Download the Sysmon configuration from: [https://github.com/magicsword-io/LOLDrivers/tree/main/detections/sysmon](https://github.com/magicsword-io/LOLDrivers/tree/main/detections/sysmon)
...
[![process](https://github.com/trustedsec/SysmonCommunityGuide/raw/master/chapters/media/image48.png)](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/media/image48.png)
...
[Permalink: What to Investigate](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#what-to-investigate)
...
[Permalink: Example Configuration: Filtering Known-Good Drivers](https://github.com/trustedsec/SysmonCommunityGuide/blob/master/chapters/driver-loading.md#example-configuration-filtering-known-good-drivers)
