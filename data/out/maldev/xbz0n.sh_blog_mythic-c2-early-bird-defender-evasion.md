...
[← Back to all posts](https://xbz0n.sh/blog)

# Mythic C2 with EarlyBird Injection and Defender Evasion

June 22, 2025· 30 min read

[Red Team](https://xbz0n.sh/blog/tag/red-team) [C2](https://xbz0n.sh/blog/tag/c2) [Mythic](https://xbz0n.sh/blog/tag/mythic) [Infrastructure](https://xbz0n.sh/blog/tag/infrastructure) [Process Injection](https://xbz0n.sh/blog/tag/process-injection) [EarlyBird](https://xbz0n.sh/blog/tag/earlybird) [OPSEC](https://xbz0n.sh/blog/tag/opsec) [Malware Development](https://xbz0n.sh/blog/tag/malware-development)

![Mythic C2 infrastructure with redirectors](https://xbz0n.sh/images/mythic-c2-infrastructure.jpeg)
...
The technique works by creating a process in a suspended state using CreateProcessW with the CREATE\_SUSPENDED flag. This creates the process but doesn't start the main thread, giving us time to inject our code. We then use VirtualAllocEx to allocate memory in the target process with execute permissions and WriteProcessMemory to write our shellcode to that allocated memory.
...
01. **Loader Starts**: Our compiled executable starts and initializes its stealth features.

02. **Download Attempt**: It tries to download the payload from `dl.example-business.com/assets/fonts/manrope-light.ttf`.

03. **Redirector Forwards**: Our Nginx redirector receives the request and forwards it to the Mythic server.

04. **Payload Retrieved**: The Apollo shellcode is downloaded and stored in memory.

05. **Process Creation**: A suspended WerFault.exe process is created.

06. **Memory Injection**: The shellcode is written to the process memory.

07. **APC Queue**: An APC is queued to execute our code.

08. **Process Resume**: The process resumes and our shellcode executes.

09. **C2 Connection**: The Apollo agent connects back to `api.example-business.com`.
...
- Normal WordPress traffic to [www.example-business.com](http://www.example-business.com/)
...
_Disclaimer: This article is provided for educational purposes only. The techniques described should only be used in authorized environments and security research contexts. Always follow responsible disclosure practices and operate within legal and ethical boundaries._

xb

### Ivan Spiridonov (xbz0n)

Offensive Security Consultant — penetration testing, red teaming, vulnerability research, and exploit development. OSCE³ certified with multiple published CVEs.

[More about me →](https://xbz0n.sh/about) [GitHub](https://github.com/xbz0n) [Twitter](https://twitter.com/xbz0n) [LinkedIn](https://www.linkedin.com/in/ivanspiridonov/)
...
Mar 24, 2025\\
\\
#red-team#c2#infrastructure](https://xbz0n.sh/blog/c2-redirectors) [**Social Engineering in Red Team Operations: Technical Setup and Tools** \\
Mar 31, 2025\\
\\
#red-team#infrastructure](https://xbz0n.sh/blog/social-engineering-redteam) [**Living Off the Land: Windows Post-Exploitation Without Tools** \\
Nov 27, 2025\\
\\
#red-team](https://xbz0n.sh/blog/living-off-the-land-windows)
