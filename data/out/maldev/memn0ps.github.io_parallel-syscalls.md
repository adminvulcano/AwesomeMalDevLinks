...
# [Parallel Syscalls](https://memn0ps.github.io/parallel-syscalls/)

2022-02-1221 min read (4465 words)

## EDR Parallel-asis through Analysis [\#](https://memn0ps.github.io/parallel-syscalls/\#edr-parallel-asis-through-analysis)
...
- C++: [https://github.com/mdsecactivebreach/ParallelSyscalls/](https://github.com/mdsecactivebreach/ParallelSyscalls/)
- Rust: [https://github.com/memN0ps/psyscalls-rs](https://github.com/memN0ps/psyscalls-rs)
- C#: [https://github.com/cube0x0/ParallelSyscalls/](https://github.com/cube0x0/ParallelSyscalls/)
- NIM: [https://github.com/frkngksl/ParallelNimcalls](https://github.com/frkngksl/ParallelNimcalls)

# Windows Internals Fundamentals [\#](https://memn0ps.github.io/parallel-syscalls/\#windows-internals-fundamentals)

## Protection Ring [\#](https://memn0ps.github.io/parallel-syscalls/\#protection-ring)

The Windows operating system has layers of privileges within the architecture known as hierarchical levels or protection rings. Regular applications run in Ring 3, known as user-mode, and privileged services run in Ring 0, Kernel mode. However, applications might need to transition from user-mode to kernel-mode.![1](https://memn0ps.github.io/Parallel-Syscalls/1.png) **Credits: [Protection ring - Wikipedia](https://en.wikipedia.org/wiki/Protection_ring)**

## Windows Architecture [\#](https://memn0ps.github.io/parallel-syscalls/\#windows-architecture)

High-level diagram view of the Window Architecture:![2](https://memn0ps.github.io/Parallel-Syscalls/2.png) **Credits: [Microsoft](https://resources.infosecinstitute.com/topic/windows-architecture-and-userkernel-mode/)**

## What are system calls [\#](https://memn0ps.github.io/parallel-syscalls/\#what-are-system-calls)

A system call or syscall is a mechanism that provides a way to transition from user-mode to kernel-mode. The system call numbers can change between different OS versions or service packs.![3](https://memn0ps.github.io/Parallel-Syscalls/3.png) **Credits: [Practical Malware Analysis](https://offensivedefence.co.uk/posts/dinvoke-syscalls/)**
...
![4](https://memn0ps.github.io/Parallel-Syscalls/4.png)
...
![5](https://memn0ps.github.io/Parallel-Syscalls/5.png)
...
![6](https://memn0ps.github.io/Parallel-Syscalls/6.png)
...
![7](https://memn0ps.github.io/Parallel-Syscalls/7.png)
...
# Introduction to Hooking and Unhooking [\#](https://memn0ps.github.io/parallel-syscalls/\#introduction-to-hooking-and-unhooking)
...
![hooking_example](https://memn0ps.github.io/Parallel-Syscalls/hooking_example.png)
...
## Unhooking [\#](https://memn0ps.github.io/parallel-syscalls/\#unhooking)
...
- [https://guidedhacking.com/threads/how-to-hook-functions-code-detouring-guide.14185/](https://guidedhacking.com/threads/how-to-hook-functions-code-detouring-guide.14185/)
...
- [https://posts.specterops.io/adventures-in-dynamic-evasion-1fe0bac57aa](https://posts.specterops.io/adventures-in-dynamic-evasion-1fe0bac57aa)
...
- [https://blog.nviso.eu/2021/10/21/kernel-karnage-part-1/](https://blog.nviso.eu/2021/10/21/kernel-karnage-part-1/)
...
## System Calls Directly [\#](https://memn0ps.github.io/parallel-syscalls/\#system-calls-directly)
...
# Introduction to the Thread Environment Block (TEB) / Process Environment Block (PEB) [\#](https://memn0ps.github.io/parallel-syscalls/\#introduction-to-the-thread-environment-block-teb--process-environment-block-peb)
...
Inside the `_PEB_LDR_DATA` data structure we have something called `InMemoryOrderModuleList` which is: [“The head of a doubly-linked list that contains the loaded modules for the process. Each item in the list is a pointer to an LDR\_DATA\_TABLE\_ENTRY structure. For more information, see Remarks.”](https://docs.microsoft.com/en-us/windows/win32/api/winternl/ns-winternl-peb_ldr_data)
...
[“A **LIST\_ENTRY** structure describes an entry in a doubly linked list or serves as the header for such a list.”](https://docs.microsoft.com/en-us/windows/win32/api/ntdef/ns-ntdef-list_entry)
...
![PE Structure](https://memn0ps.github.io/Parallel-Syscalls/peb.png)
...
# Introduction to Portable Executable Files [\#](https://memn0ps.github.io/parallel-syscalls/\#introduction-to-portable-executable-files)
...
![PE Structure](https://memn0ps.github.io/Parallel-Syscalls/PE-Structure.png)**Credits: [PE Structure](https://tech-zealots.com/wp-content/uploads/2018/05/PE-Structure.png)**

![4](https://memn0ps.github.io/Parallel-Syscalls/pe_file.png)

**Credits: [PE Structure](https://tech-zealots.com/malware-analysis/pe-portable-executable-structure-malware-analysis-part-2/)**

### [\_IMAGE\_DOS\_HEADER](https://0xrick.github.io/win-internals/pe3/) [\#](https://memn0ps.github.io/parallel-syscalls/\#_image_dos_headerhttps0xrickgithubiowin-internalspe3)
...
The first bytes of the Portable Executable (PE) file are, the traditional MS-DOS header, also called the IMAGE\_DOS\_HEADER structure.
...
### [\_IMAGE\_NT\_HEADERS](https://docs.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-image_nt_headers32) [\#](https://memn0ps.github.io/parallel-syscalls/\#_image_nt_headershttpsdocsmicrosoftcomen-uswindowswin32apiwinntns-winnt-image_nt_headers32)
...
### [\_IMAGE\_OPTIONAL\_HEADER](https://docs.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-image_optional_header32) [\#](https://memn0ps.github.io/parallel-syscalls/\#_image_optional_headerhttpsdocsmicrosoftcomen-uswindowswin32apiwinntns-winnt-image_optional_header32)
...
### [\_IMAGE\_DATA\_DIRECTORY](https://docs.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-image_data_directory) [\#](https://memn0ps.github.io/parallel-syscalls/\#_image_data_directoryhttpsdocsmicrosoftcomen-uswindowswin32apiwinntns-winnt-image_data_directory)
...
### [\_IMAGE\_SECTION\_HEADER](https://docs.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-image_section_header) [\#](https://memn0ps.github.io/parallel-syscalls/\#_image_section_headerhttpsdocsmicrosoftcomen-uswindowswin32apiwinntns-winnt-image_section_header)
...
### [\_IMAGE\_EXPORT\_DIRECTORY](https://alice.climent-pommeret.red/posts/direct-syscalls-hells-halos-syswhispers2/) [\#](https://memn0ps.github.io/parallel-syscalls/\#_image_export_directoryhttpsalicecliment-pommeretredpostsdirect-syscalls-hells-halos-syswhispers2)
...
**Credits: [\_IMAGE\_EXPORT\_DIRECTORY](https://alice.climent-pommeret.red/posts/direct-syscalls-hells-halos-syswhispers2/)**

Here is an excellent image that shows an overview of what we have talked about above.

![PE Structures](https://memn0ps.github.io/Parallel-Syscalls/pe_diagram.jpg)
...
![EAT](https://memn0ps.github.io/Parallel-Syscalls/eat.png)
...
- [https://0xevilc0de.com/locating-dll-name-from-the-process-environment-block-peb/](https://0xevilc0de.com/locating-dll-name-from-the-process-environment-block-peb/)
- [https://resources.infosecinstitute.com/topic/the-export-directory/](https://resources.infosecinstitute.com/topic/the-export-directory/)
- [https://blogs.keysight.com/blogs/tech/nwvs.entry.html/2020/07/27/debugging\_malwarewi-hk5u.html](https://blogs.keysight.com/blogs/tech/nwvs.entry.html/2020/07/27/debugging_malwarewi-hk5u.html)
...
- [https://mohamed-fakroud.gitbook.io/red-teamings-dojo/shellcoding/leveraging-from-pe-parsing-technique-to-write-x86-shellcode](https://mohamed-fakroud.gitbook.io/red-teamings-dojo/shellcoding/leveraging-from-pe-parsing-technique-to-write-x86-shellcode)
...
## Parallel-asis [\#](https://memn0ps.github.io/parallel-syscalls/\#parallel-asis)
...
- [https://blogs.blackberry.com/en/2017/10/windows-10-parallel-loading-breakdown](https://blogs.blackberry.com/en/2017/10/windows-10-parallel-loading-breakdown).
- [https://stackoverflow.com/questions/42789199/why-there-are-three-unexpected-worker-threads-when-a-win32-console-application-s](https://stackoverflow.com/questions/42789199/why-there-are-three-unexpected-worker-threads-when-a-win32-console-application-s)

# Rust [\#](https://memn0ps.github.io/parallel-syscalls/\#rust)

I’ve ported the code to Rust, which can be tuned to make a library for system calls.

[https://github.com/memN0ps/psyscalls-rs](https://github.com/memN0ps/psyscalls-rs)

## Why Rust? [\#](https://memn0ps.github.io/parallel-syscalls/\#why-rust)
...
This project has allowed me to learn about Rust Windows Internals and enhance my reverse engineering skills. I’m relatively new to Rust, but I firmly believe Rust is the future for robust programs or offensive security.

Read more about Rust here:

- [https://kerkour.com/why-rust-for-offensive-security/](https://kerkour.com/why-rust-for-offensive-security/)
- [https://zerotomastery.io/blog/why-you-should-learn-rust/](https://zerotomastery.io/blog/why-you-should-learn-rust/)
- [https://github.com/skerkour/black-hat-rust](https://github.com/skerkour/black-hat-rust)
- [https://github.com/trickster0/OffensiveRust](https://github.com/trickster0/OffensiveRust)
- [https://github.com/Kudaes/DInvoke\_rs](https://github.com/Kudaes/DInvoke_rs)
- [https://github.com/zorftw/kdmapper-rs](https://github.com/zorftw/kdmapper-rs)
- [https://github.com/postrequest/link](https://github.com/postrequest/link)
- [https://github.com/kmanc/remote\_code\_oxidation](https://github.com/kmanc/remote_code_oxidation)
...
## References [\#](https://memn0ps.github.io/parallel-syscalls/\#references)

