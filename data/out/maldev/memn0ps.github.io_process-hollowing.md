...
2022-02-235 min read (956 words)
...
## [CreateProcessA](https://docs.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessa) [\#](https://memn0ps.github.io/process-hollowing/\#createprocessahttpsdocsmicrosoftcomen-uswindowswin32apiprocessthreadsapinf-processthreadsapi-createprocessa)
...
### [NtQueryInformationProcess](https://docs.microsoft.com/en-us/windows/win32/api/winternl/nf-winternl-ntqueryinformationprocess) [\#](https://memn0ps.github.io/process-hollowing/\#ntqueryinformationprocesshttpsdocsmicrosoftcomen-uswindowswin32apiwinternlnf-winternl-ntqueryinformationprocess)
...
### [Process Environment Block (PEB)](https://docs.microsoft.com/en-us/windows/win32/api/winternl/ns-winternl-peb) [\#](https://memn0ps.github.io/process-hollowing/\#process-environment-block-pebhttpsdocsmicrosoftcomen-uswindowswin32apiwinternlns-winternl-peb)
...
## [ReadProcessMemory](https://docs.microsoft.com/en-us/windows/win32/api/memoryapi/nf-memoryapi-readprocessmemory) [\#](https://memn0ps.github.io/process-hollowing/\#readprocessmemoryhttpsdocsmicrosoftcomen-uswindowswin32apimemoryapinf-memoryapi-readprocessmemory)
...
### [IMAGE\_DOS\_HEADER](https://www.nirsoft.net/kernel_struct/vista/IMAGE_DOS_HEADER.html) [\#](https://memn0ps.github.io/process-hollowing/\#image_dos_headerhttpswwwnirsoftnetkernel_structvistaimage_dos_headerhtml)
...
### [IMAGE\_NT\_HEADERS](https://docs.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-image_nt_headers32) [\#](https://memn0ps.github.io/process-hollowing/\#image_nt_headershttpsdocsmicrosoftcomen-uswindowswin32apiwinntns-winnt-image_nt_headers32)
...
### [\_IMAGE\_OPTIONAL\_HEADER64](https://docs.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-image_optional_header64) [\#](https://memn0ps.github.io/process-hollowing/\#_image_optional_header64httpsdocsmicrosoftcomen-uswindowswin32apiwinntns-winnt-image_optional_header64)
...
### Virtual Address of EntryPoint [\#](https://memn0ps.github.io/process-hollowing/\#virtual-address-of-entrypoint)
...
## [WriteProcessMemory](https://docs.microsoft.com/en-us/windows/win32/api/memoryapi/nf-memoryapi-writeprocessmemory) and [ResumeThread](https://docs.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-resumethread) [\#](https://memn0ps.github.io/process-hollowing/\#writeprocessmemoryhttpsdocsmicrosoftcomen-uswindowswin32apimemoryapinf-memoryapi-writeprocessmemory-and-resumethreadhttpsdocsmicrosoftcomen-uswindowswin32apiprocessthreadsapinf-processthreadsapi-resumethread)
...
## PoC [\#](https://memn0ps.github.io/process-hollowing/\#poc)

A PoC has been made in Rust using `NTAPI` (`ntdll.dll`) rather than using `winapi` (`kernel32.dll / kernelbase.dll`).

[https://github.com/memN0ps/arsenal-rs/tree/main/process\_hollowing-rs](https://github.com/memN0ps/arsenal-rs/tree/main/process_hollowing-rs)

## [Detection on Virus Total](https://www.virustotal.com/gui/file/054783446c4e72a1d46b4cca5f57128ad55ebde1511dbdd5f40be6d497644193?nocache=1) [\#](https://memn0ps.github.io/process-hollowing/\#detection-on-virus-totalhttpswwwvirustotalcomguifile054783446c4e72a1d46b4cca5f57128ad55ebde1511dbdd5f40be6d497644193nocache1)

Detection at the time of writing.

![Detection](https://memn0ps.github.io/Process-Hollowing/detection.png)

## References [\#](https://memn0ps.github.io/process-hollowing/\#references)

- [https://memn0ps.github.io/Parallel-Syscalls/](https://memn0ps.github.io/Parallel-Syscalls/)
- [https://github.com/memN0ps/arsenal-rs/](https://github.com/memN0ps/arsenal-rs/)
- [https://docs.microsoft.com](https://docs.microsoft.com/)
- [https://en.wikipedia.org/wiki/Svchost.exe](https://en.wikipedia.org/wiki/Svchost.exe)
- [https://0xrick.github.io/win-internals/pe5/](https://0xrick.github.io/win-internals/pe5/)
- [https://www.nirsoft.net/kernel\_struct/vista/IMAGE\_DOS\_HEADER.html](https://www.nirsoft.net/kernel_struct/vista/IMAGE_DOS_HEADER.html)
