...
[Skip to content](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack) to refresh your session.Dismiss alert

{{ message }}

[V-i-x-x](https://github.com/V-i-x-x)/ **[win11-kernel-execution-syscall-hijack](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack)** Public

- [Notifications](https://github.com/login?return_to=%2FV-i-x-x%2Fwin11-kernel-execution-syscall-hijack) You must be signed in to change notification settings
- [Fork\\
11](https://github.com/login?return_to=%2FV-i-x-x%2Fwin11-kernel-execution-syscall-hijack)
- [Star\\
80](https://github.com/login?return_to=%2FV-i-x-x%2Fwin11-kernel-execution-syscall-hijack)


main

[**1** Branch](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/branches) [**0** Tags](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/tags)

[Go to Branches page](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/branches)[Go to Tags page](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/tags)
...
| --- | --- | --- | --- |
| ## Latest commit<br>[![V-i-x-x](https://avatars.githubusercontent.com/u/21037679?v=4&size=40)](https://github.com/V-i-x-x)[V-i-x-x](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/commits?author=V-i-x-x)<br>[Update Readme.md](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/commit/b3f7bc47cc6c0c7927b42469aa78975aa4d37ef7)<br>2 weeks agoJun 7, 2026<br>[b3f7bc4](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/commit/b3f7bc47cc6c0c7927b42469aa78975aa4d37ef7) · 2 weeks agoJun 7, 2026<br>## History<br>[6 Commits](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/commits/main/) <br>Open commit details<br>[View commit history for this file.](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/commits/main/) 6 Commits |
| [KernelCodeExecution](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/tree/main/KernelCodeExecution "KernelCodeExecution") | [KernelCodeExecution](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/tree/main/KernelCodeExecution "KernelCodeExecution") | [Arguments Supports and 2 new Features](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/commit/ff4e87f74687ef9900d55da2a3c8c778065e617a "Arguments Supports and 2 new Features  /privesc and /ppl + Arguments supports for researchers.") | 2 weeks agoJun 7, 2026 |
| [screenshots](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/tree/main/screenshots "screenshots") | [screenshots](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/tree/main/screenshots "screenshots") | [Fix Readme](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/commit/f6e5a3078c61f663a8e23cc215ea8d9be48b5c57 "Fix Readme  Fix Readme") | last yearJun 7, 2025 |
| [Readme.md](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/blob/main/Readme.md "Readme.md") | [Readme.md](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/blob/main/Readme.md "Readme.md") | [Update Readme.md](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/commit/b3f7bc47cc6c0c7927b42469aa78975aa4d37ef7 "Update Readme.md") | 2 weeks agoJun 7, 2026 |
| View all files |
...
[Permalink: 🚀 Blog Title: Executing Kernel Routines via Syscall Table Hijack](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-blog-title-executing-kernel-routines-via-syscall-table-hijack)

### 🔍 Overview

[Permalink: 🔍 Overview](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-overview)
...
[Permalink: 🧨 Offensive Applications & APT Use Cases](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-offensive-applications--apt-use-cases)
...
[Permalink: 🔑 Starting Point: Gaining a Read/Write Primitive](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-starting-point-gaining-a-readwrite-primitive)
...
[Permalink: 📚 Prerequisites](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-prerequisites)
...
[Permalink: 🧠 Key Concepts](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-key-concepts)
...
[Permalink: Hijacking NtSetQuotaInformationFile Syscall](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#hijacking-ntsetquotainformationfile-syscall)
...
[Permalink: Extracting the Syscall Number](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#extracting-the-syscall-number)
...
[![NtSetQuotaInformationFile](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/raw/main/screenshots/NtSetQuotaInformationFile.png)](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/blob/main/screenshots/NtSetQuotaInformationFile.png)[![Syscall Number](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/raw/main/screenshots/syscall_number.png)](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/blob/main/screenshots/syscall_number.png)
...
[Permalink: Understanding nt!KiServiceTable](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#understanding-ntkiservicetable)
...
[Permalink: Redirecting the Syscall to Our Target](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#redirecting-the-syscall-to-our-target)
...
[Permalink: Bypassing Read-Only Protection](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#bypassing-read-only-protection)
...
pfn 7f7       ---DA--KWEV  pfn 829       ---DA--KWEV  pfn 11bc00    -GLDA--KR-V  LARGE PAGE pfn 11bcd9
```
...
[Permalink: Summary](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#summary)
...
[Permalink: Code Walkthrough](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#code-walkthrough)
...
[Permalink: 1. Find ntoskrnl Base Address](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#1-find-ntoskrnl-base-address)
...
[Permalink: 2. Read Address of KiServiceTable](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#2-read-address-of-kiservicetable)
...
fffff802`e6bc5280  fffff802`e5cd97a0 nt!KiServiceTable
...
Evaluate expression: 16536192 = 00000000`00fc5280
```

#### 3\. **Get PTE (Page Table Entry) Base Address in kernel memory.**

[Permalink: 3. Get PTE (Page Table Entry) Base Address in kernel memory.](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#3-get-pte-page-table-entry-base-address-in-kernel-memory)
...
[Permalink: 4. Get PDE for KiServiceTable and Flip R/W Bit](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#4-get-pde-for-kiservicetable-and-flip-rw-bit)
...
[Permalink: 5. Hijack the Syscall](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#5-hijack-the-syscall)
...
[Permalink: 6. Call the Hijacked Syscall using asm](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#6-call-the-hijacked-syscall-using-asm)
...
[Permalink: 7. Read Process Name](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#7-read-process-name)
...
[Permalink: 8. Cleanup](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#8-cleanup)
...
[Permalink: 🧾 Offsets — what's dynamic vs. what you must verify](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-offsets--whats-dynamic-vs-what-you-must-verify)
...
[Permalink: ✅ Dynamic — handled automatically by kernelHelper::resolveKernelArtifacts()](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-dynamic--handled-automatically-by-kernelhelperresolvekernelartifacts)
...
[Permalink: ⚠️ Manual — verify in WinDbg before running](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#%EF%B8%8F-manual--verify-in-windbg-before-running)
...
[Permalink: 🧪 One paste-block to verify everything before running](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-one-paste-block-to-verify-everything-before-running)
...
| `+0x??? ImageFileName` | `imageFileNameOffset` _(all three demos)_ |
| `+0x??? Token` | `tokenOffset` _(`/privesc`)_ |
| `+0x??? Protection` | `protectionOffset` _(`/ppl` only)_ |
...
[Permalink: 🧬 Generalizing the hijack — calling any API with any arity](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-generalizing-the-hijack--calling-any-api-with-any-arity)

There are two pieces here: **the table entry** (how the kernel finds the routine to call), and **the arguments** (how data gets from your `((PFN_HSC_N)HijackedSyscall)(...)` C++ call all the way into the hijacked routine's registers and stack). They're independent — the entry tells the kernel _what to call_, the calling convention tells it _what to pass_.

#### The `KiServiceTable` entry — a packed 32-bit DWORD

[Permalink: The KiServiceTable entry — a packed 32-bit DWORD](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#the-kiservicetable-entry--a-packed-32-bit-dword)
...
- **Bits 4..31** — `(routine_addr − KiServiceTable)` shifted _left_ by 4. The kernel reads them back with an arithmetic shift right by 4, so the offset is treated as signed (the routine can sit below the table, though in practice it doesn't).
...
[Permalink: How arguments flow into the hijacked routine](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#how-arguments-flow-into-the-hijacked-routine)
...
[Permalink: Putting it together](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#putting-it-together)
...
[Permalink: 🔓 Privesc demo — /privesc <PID>](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-privesc-demo--privesc-pid)
...
3. Read both `EPROCESS.Token` (EX\_FAST\_REF) values through the existing R/W primitive. Compute `newToken = (system & ~0xF) | (target & 0xF)` — keep the target's cached ref count, take SYSTEM's pointer bits.
...
[Permalink: 🛡️ PPL toggle — /ppl <PID> <0|1>](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#%EF%B8%8F-ppl-toggle--ppl-pid-01)
...
[Permalink: 🔐 Security Bypass Summary](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-security-bypass-summary)
...
[Permalink: 🕵️ EDR sidestep — using the hijack itself as the kernel R/W primitive](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#%EF%B8%8F-edr-sidestep--using-the-hijack-itself-as-the-kernel-rw-primitive)

The most common BYOVD detection signal isn't the _technique_ — it's the **volume of IOCTLs the vulnerable driver receives**. RTCore64 in particular has well-known IOCTL signatures; an EDR that sees the same process pinging it dozens of times per second has a reliable IOC even without ever inspecting _what's_ being read.
...
[Permalink: The threat-model shift, visually](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#the-threat-model-shift-visually)
...
[Permalink: Honest scope — what this does and doesn't hide](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#honest-scope--what-this-does-and-doesnt-hide)
...
So the vulnerable driver is **never invisible** — it's visible for a short, bounded setup burst and then goes quiet. An EDR that already alerts on RTCore64 _loading_, or on the very first IOCTL, still catches the bootstrap. What this defeats is the **sustained IOCTL pattern** that long-lived implants would otherwise generate.

#### Where this is useful

[Permalink: Where this is useful](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#where-this-is-useful)
...
- **Heuristic IOCTL-rate detections.** Many EDRs key on the _rate_ of suspicious IOCTLs to a known-vulnerable driver more than on the first one. Collapsing steady-state traffic to a single setup burst sidesteps that class of heuristic.
...
[Permalink: ✅ POC (Proof of Concept)](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-poc-proof-of-concept)
...
[Permalink: CLI](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#cli)
...
[![POC](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/raw/main/screenshots/POC.png)](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/blob/main/screenshots/POC.png)

* * *

### 🧯 Warning

[Permalink: 🧯 Warning](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-warning)
...
[Permalink: ✅ Conclusion](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#-conclusion)
...
[kernel](https://github.com/topics/kernel "Topic: kernel") [reverse-engineering](https://github.com/topics/reverse-engineering "Topic: reverse-engineering") [kernel-exploitation](https://github.com/topics/kernel-exploitation "Topic: kernel-exploitation") [kernel-exploit](https://github.com/topics/kernel-exploit "Topic: kernel-exploit") [windows-11](https://github.com/topics/windows-11 "Topic: windows-11")

### Resources

[Readme](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack#readme-ov-file)

### Uh oh!

There was an error while loading. [Please reload this page](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack).

[Activity](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/activity)

### Stars

[**80**\\
stars](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/stargazers)

### Watchers

[**0**\\
watching](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/watchers)

### Forks

[**11**\\
forks](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2FV-i-x-x%2Fwin11-kernel-execution-syscall-hijack&report=V-i-x-x+%28user%29)

## [Releases](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/releases)

No releases published

## [Packages\  0](https://github.com/users/V-i-x-x/packages?repo_name=win11-kernel-execution-syscall-hijack)

No packages published

## [Contributors\  1](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/graphs/contributors)

- [![@V-i-x-x](https://avatars.githubusercontent.com/u/21037679?s=64&v=4)](https://github.com/V-i-x-x)[**V-i-x-x** Vixx](https://github.com/V-i-x-x)

## Languages

- [C++88.9%](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/search?l=c%2B%2B)
- [C9.1%](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/search?l=c)
- [Assembly2.0%](https://github.com/V-i-x-x/win11-kernel-execution-syscall-hijack/search?l=assembly)
